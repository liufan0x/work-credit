 ...
 */
@ApiModel(value = "回款报备")
public class RepaymentPreparationDto extends BaseDto{
	
	private static final long serialVersionUID = 1L;
		

	/** 回款报备 */
	@ApiModelProperty(value = "回款报备")
	...
	private java.lang.Integer cooperativeAgencyId;
	
	/** 合作机构 */
	@ApiModelProperty(value = "合作机构")
	private java.lang.String cooperativeAgencyName;
	
	/** 预计回款时间 */
	@ApiModelProperty(value = "预计回款时间")
	private java.util.Date estimateInLoanTime;
	
	/** 回款方式 */
	@ApiModelProperty(value = "回款方式")
	private java.lang.String inLoanType;
	
	/** 报备状态(0:初始化1:已回款,2,未回款,3:报备撤销) */
	@ApiModelProperty(value = "报备状态(0:初始化1:已回款,2,未回款,3:报备撤销)")
	...
	/** 回款开始时间(主要用于列表检索) */
	@ApiModelProperty(value = "回款开始时间(主要用于列表检索)")
    private Date  estimateInLoanStartTime;
    
	/** 回款结束时间(主要用于列表检索) */
	@ApiModelProperty(value = "回款结束时间(主要用于列表检索)")
    private Date  estimateInLoanEndTime;

	/** 报备开始时间(主要用于列表检索) */
	@ApiModelProperty(value = "报备开始时间(主要用于列表检索)")
	private Date createStartTime;

	/** 报备结束时间(主要用于列表检索) */
	@ApiModelProperty(value = "报备结束时间(主要用于列表检索)")
	private Date createEndTime;

	/** 预计回款时间排序 */
	@ApiModelProperty(value = "预计回款时间排序")
	private String estimateInLoanTimeOrderBy;
	...
	public void setCooperativeAgencyId(java.lang.Integer value) {
		this.cooperativeAgencyId = value;
	}	
	public java.lang.Integer getCooperativeAgencyId() {
		return this.cooperativeAgencyId;
	}
	public void setCooperativeAgencyName(java.lang.String value) {
		this.cooperativeAgencyName = value;
	}	
	public java.lang.String getCooperativeAgencyName() {
		return this.cooperativeAgencyName;
	}
	public void setEstimateInLoanTime(java.util.Date value) {
		this.estimateInLoanTime = value;
	}	
	public java.util.Date getEstimateInLoanTime() {
		return this.estimateInLoanTime;
	}
	public void setInLoanType(java.lang.String value) {
		this.inLoanType = value;
	}	
	public java.lang.String getInLoanType() {
		return this.inLoanType;
	}
	...
	public void setCustomerTypeName(java.lang.String value) {
	...
	public Date getEstimateInLoanStartTime() {
		return estimateInLoanStartTime;
	}
	public void setEstimateInLoanStartTime(Date estimateInLoanStartTime) {
		this.estimateInLoanStartTime = estimateInLoanStartTime;
	}
	public Date getEstimateInLoanEndTime() {
		return estimateInLoanEndTime;
	}
	public void setEstimateInLoanEndTime(Date estimateInLoanEndTime) {
		this.estimateInLoanEndTime = estimateInLoanEndTime;
	}
	...
	public String getEstimateInLoanTimeOrderBy() {
		return estimateInLoanTimeOrderBy;
	}
	public void setEstimateInLoanTimeOrderBy(String estimateInLoanTimeOrderBy) {
		this.estimateInLoanTimeOrderBy = estimateInLoanTimeOrderBy;
	}
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("cooperativeAgencyId",getCooperativeAgencyId())
			.append("cooperativeAgencyName",getCooperativeAgencyName())
			.append("estimateInLoanTime",getEstimateInLoanTime())
			.append("inLoanType",getInLoanType())
			.append("status",getStatus())
			.append("remark",getRemark())
			.append("relationOrderNo",getRelationOrderNo())
			.append("top",getTop())
			.append("customerType",getCustomerType())
			.append("customerTypeName",getCustomerTypeName())
