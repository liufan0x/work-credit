...
public class YntrustBorrowDto extends BaseDto {
     ...
     */
    @ApiModelProperty(value = "云南信托借款人信息")
    private Integer id;
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "客户姓名->订单借款人姓名")
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "银行开户预留手机号(默认订单手机号码)")
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "婚姻状况(10:未婚,20:已婚,21:初婚,22:再婚,23:复婚,30:丧偶,40:离婚,90:未说明的婚姻状况)")
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "11位有效手机号码")
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "居住城市(省市区三级的地区code)")
    private String city;
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "职业分类(传对应数字，1=政府部门，2=教科文，3=金融，4=商贸，5=房地产，6=制造业，7=自由职业)")
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "角色分类(贷款借款人=1；其他投融资交易对手=2；抵质押人担保人贷款类=3；抵质押人担保人非贷款类=4；委托方=5；其他对手方等付费对象=6)")
     ...
     * @mbggenerated 2018-03-08
     */
    @ApiModelProperty(value = "角色分类分类名称")
     ...
     * 与云南信托合同全局唯一id
     */
    @ApiModelProperty(value = "与云南信托合同全局唯一id")
