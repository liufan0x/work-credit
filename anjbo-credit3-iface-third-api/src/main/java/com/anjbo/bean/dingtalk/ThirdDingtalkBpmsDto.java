...
public class ThirdDingtalkBpmsDto extends BaseDto implements Serializable {
	...
	*名称：审批实例发起人的userid
	*/
	@ApiModelProperty("审批实例发起人的userid")
	private String originatorUserId;
	@ApiModelProperty("审批实例发起人名称")
