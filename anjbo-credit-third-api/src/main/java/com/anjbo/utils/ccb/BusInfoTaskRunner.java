...
public class BusInfoTaskRunner implements Runnable {
	...
	String BusInfoDir = ThirdConfigUtil.getProperty("BusInfoDir");
	String BusInfoZipDir = ThirdConfigUtil.getProperty("BusInfoZipDir");
	String rsync = ThirdConfigUtil.getProperty("rsync");
	...
	public void init(String code, String orderNo, String appNo, String subBankId) {
		this.code = code;
	...
	private String zipBusInfo(String orderNo, String appNo, String code) throws ParseException {
		...
		try {
			...
			busInfos=new HttpUtil().getList(Constants.LINK_CMCREDIT.toString(),
