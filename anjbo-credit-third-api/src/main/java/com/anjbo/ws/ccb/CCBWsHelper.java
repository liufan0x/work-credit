...
public class CCBWsHelper {
	...
	private static RespDataObject<Map<String,Object>> post(String tranNo,Object obj){
		String bankNo = ThirdConfigUtil.getProperty(CCBEnums.GLOBAL_CONFIG_KEY.CCB_BANKNO.toString());
	...
	public static RespDataObject<Map<String,Object>> postOp(String tranNo,Object obj,String bankNo){
		...
		try {
			...
			jsonObj.put("comNo",ThirdConfigUtil.getProperty(CCBEnums.GLOBAL_CONFIG_KEY.CCB_COMNO.toString()));
			jsonObj.put("bankNo",bankNo);
			jsonObj.put("channelNo",ThirdConfigUtil.getProperty(CCBEnums.GLOBAL_CONFIG_KEY.CCB_CHANNELNO.toString()));
			jsonObj.put("isn",CCBUtil.getID());
			String queryCondition = FreemarkerHelper.getIns().processTemplate("ccb/"+ftlName, jsonObj);
