...
public class SMSSender implements Callable<RespStatus> {
	...
	private static final String SMSURL2 = "smsSend4.act";
	...
	private RespStatus smsSend(String phone, String ip, String smsContent,
		...
		try {
			...
			String url = Constants.LINK_ANJBO_AMS_URL+SMSURL2;
			result = SingleUtils.getRestTemplate().getForObject(url+"?"+AmsUtil.getHttpUrl(params),String.class);
