 ...
 *
 */
public class LendingInstructionsDto  extends OrderBaseBorrowDto{
	...
	public Integer getOpeningBankId() {
		return openingBankId;
	}
	public void setOpeningBankId(Integer openingBankId) {
