 ...
 * @version 1.0
 */
@ApiModel(value = "首席风险官审批")
public class AuditOfficerDto extends BaseDto{
	
	private static final long serialVersionUID = 1L;
		

	/** 首席风险官审批 */
	@ApiModelProperty(value = "首席风险官审批")
	...
	/** 法务审批UID */
	@ApiModelProperty(value = "法务审批UID")
	private java.lang.String justiceUid;
	...
	public void setJusticeUid(java.lang.String value) {
		this.justiceUid = value;
	}	
	public java.lang.String getJusticeUid() {
		return this.justiceUid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("justiceUid",getJusticeUid())
			.toString();
	}
}
