...
import com.anjbo.utils.signature.BASE64;
...
//        }
    ...
    public String initSdk(boolean isInit){
        ...
        try {
            if (null == this.SDK || isInit) {
                ...
                projectConfig.setItsmApiUrl(ThirdApiConstants.SIGNATURE_URL);
                projectConfig.setProjectId(ThirdApiConstants.SIGNATURE_PROJECTID);
                projectConfig.setProjectSecret(ThirdApiConstants.SIGNATURE_PROJECT_SECRET);
                log.info("测试环境---PROJECTID{" + ThirdApiConstants.SIGNATURE_PROJECTID + "},PROJECTSECRET{" + ThirdApiConstants.SIGNATURE_PROJECT_SECRET + "},ITSMAPIURL{" + ThirdApiConstants.SIGNATURE_URL + "}");
	...
	public List<Map<String,Object>> getFileBytes(List<Map<String,Object>> list, RespDataObject<Map<String,Object>> result){
        ...
        RespDataObject<List<Map<String,Object>>> tmp = SingleUtils.getRestTemplate().postForObject(FS_URL+"/fs/yntrust/getFileBytes", requestEntity, RespDataObject.class);
    ...
    public RespDataObject<Map<String,Object>> upload(byte[] bytes, String fileName) throws IOException {
        ...
        JSONObject jsonObject = filePostJSONObject(inputStream,fileName,null,"application/pdf");
    ...
    public RespDataObject<Map<String,Object>> upload(InputStream in){
        ...
        JSONObject jsonObject = filePostJSONObject(in,UUID.randomUUID().toString().replaceAll("-","")+".jpg", map, "image/jpeg");
        RespDataObject<Map<String,Object>> respDataObject = null;
        if(null!=jsonObject){
            respDataObject  = gson.fromJson(jsonObject.toString(), RespDataObject.class);
        } else {
    ...
    public JSONObject filePostJSONObject(InputStream fis, String fileName,Map<String,Object> param,String contentType) {
        String tmp = fileName;
        ...
        String FS_URL = Constants.LINK_ANJBO_FS_URL;
        Map<String,Object> map = null==param?new HashMap<String,Object>():param;
