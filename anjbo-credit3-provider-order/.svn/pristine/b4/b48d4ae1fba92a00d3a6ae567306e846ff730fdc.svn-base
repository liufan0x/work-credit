...
import com.anjbo.dao.finance.ReceivableForMapper;
 ...
 */
@Service
public class ReceivableForServiceImpl extends BaseServiceImpl<ReceivableForDto>  implements ReceivableForService {
	@Autowired private ReceivableForMapper receivableForMapper;
