angular.module("anjboApp").controller("placeCreditEditCDCtrl",function($scope,$timeout,$rootScope,$http,$state,route,box){
	...
	$scope.submitCredit = function(isShow) {
		if(null==$scope.credit || undefined==$scope.creditForm){
			return;
		}
