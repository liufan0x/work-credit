...
//		message = new MimeMessage(session);
	...
	private void doSendHtmlEmail(String subject, String sendHtml,
			String[] receiveUsers, File[] attachment) throws AnjboException {
//		try {
//			// 发件人
...
//		} catch (Exception e) {
//			e.printStackTrace();
//			throw new AnjboException("-1",e.getMessage());
//		} finally {
//			if (transport != null) {
//				try {
//					transport.close();
...
//		}
	 ...
	 * @throws AnjboException 
	 */
	public static void sendEmial(String title,String content,String email) throws AnjboException{
	 ...
	 * @throws AnjboException 
	 */
	public static void sendEmial(String title,String content,String []emails) throws AnjboException{
		EmailUtil se = new EmailUtil(false);
	 ...
	 * @throws AnjboException 
	 */
	public static void sendEmial(String title,String content,String []emails,File[] files) throws AnjboException{
		EmailUtil se = new EmailUtil(false);
